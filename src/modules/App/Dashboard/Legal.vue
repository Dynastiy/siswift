<template>
  <div class="p-6 bg-white">
    <h4 class="mb-3 font-semibold">Terms and Conditions</h4>
    ...
    the like). Where does it come from? Contrary to popular belief, Lorem Ipsum is not simply random
    ...
    1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus
    Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by
    English versions from the 1914 translation by H. Rackham. Where can I get some? There are many
